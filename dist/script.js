    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          ...
          if (i % 2 == 0) {
            blockedElem.setAttribute('data-desabled', 'true');
          }
        } catch (e) {}

        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-desabled') !== 'true') {
            _this.activeBtn = btn;
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n === 3) {
          this.hanson.classList.add('anamated');
          setTimeout(function () {
